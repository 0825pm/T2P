...
class LMMultiHead(nn.Module):
    ...
    def forward_t5(
        ...
        return {'loss': loss,
                ...
                'logits_body': lm_logits,
                'logits_lhand': lm_logits_hand,
    ...
    def inference_decoder(
        ...
        if self.model_type in ['mbart_multi']:
            ...
            decoder_embeds_lhand = token_embeds(decoder_input_ids_hand)
            decoder_embeds_rhand = token_embeds(decoder_input_ids_rhand)
    ...
    def forward_mbart(
        ...
        return {'loss': loss,
                'loss_hand': loss_hand,
                'loss_rhand': loss_rhand,
                'logits_body': lm_logits_body,
                'logits_lhand': lm_logits_lhand,
                'logits_rhand': lm_logits_rhand,
                }
